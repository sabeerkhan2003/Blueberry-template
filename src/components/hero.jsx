  ...
  return (
    ...
    <div className='mt-6 flex flex-col-reverse m-5 lg:flex lg:flex-row lg:justify-center lg:gap-[10%] '>
      <div className='font-poppins ml-4 flex flex-col gap-3 lg:justify-center'>
        ...
        <h1 className='bg-[#] inline-block '>Explore <span className='text-[#6C7FD8]'>Healthy</span></h1><br className='hidden md:block'></br>
          <h1 className='bg-[#] inline-block '>& Fresh Fruits</h1></div>
